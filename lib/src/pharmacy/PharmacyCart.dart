...
class _PharmacyCartScreenState extends State<PharmacyCartScreen> {
  ...
  void initState() {
    super.initState();
    String cleanPrice = widget.itemPrice.replaceAll(RegExp(r'[^0-9.]'), '');
    pricePerItem = double.tryParse(cleanPrice) ?? 0.0;
  }
          ...
          children: [
            ...
            if (quantity > 0)
              Row(
                ...
                children: [
                  /// Product Image (Using Icon if image missing)
                  Container(
                    height: 90,
                    width: 90,
                    ...
                    child: const Icon(Icons.medication, color: Color(0xFF1DA1F2), size: 40),
                  ),
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(
                          widget.itemName, // 3. Use dynamic Name
                        ...
                        Text(
                          widget.itemPrice, // Display original price string
              ...
              const Padding(
                ...
                child: Text("Cart is empty", style: TextStyle(fontSize: 18, color: Colors.grey)),
              ),
